...
Thanks for following along! You can view the final webpage by clicking the green download button on the following link and opening the index.html file in the 01 folder in any web browser. 
